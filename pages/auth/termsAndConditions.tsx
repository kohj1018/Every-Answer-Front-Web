...
const TermsAndConditions: NextPage = () => {
  ...
  return (
    <MainContainer isHiddenHeaderAndFooterOnMobile={true}>
      <MobileCenterTitleHeader title='약관동의' link='/' />

      <main className='relative min-h-screen pt-[5.5625rem] px-5 lg:mainWidthLimit lg:pt-[7.8125rem]'>
        <Link href='/auth/signIn' className='hidden items-center space-x-1 lg:flex'>
          <ChevronLeft className='w-5 h-5 text-gray-300' />
          <p className='text-lg font-semibold text-gray-800'>약관동의</p>
        </Link>

        <article className='space-y-1 lg:mt-8 lg:space-y-2'>
          <h2 className='text-xl font-semibold text-black lg:text-3xl'>약관동의</h2>
          <h3 className='text-sm font-semibold text-gray-400 lg:text-lg'>에브리엔서 서비스 이용을 위해 약관 동의가 필요합니다.</h3>
        </article>

        <section className='mt-8 space-y-6 lg:mt-12 lg:space-y-9'>
          <article className='space-y-3.5 lg:space-y-5'>
            <div className='flex items-center justify-between'>
              <p className='text-sm font-semibold text-gray-900 lg:text-lg'><span className='text-blue-500'>(필수) </span>EveryAnswer서비스이용약관</p>
              <button
...
const terms = <>
  <h3>제1조(목적)</h3>
  <p>에브리엔서 서비스 이용약관은 에브리엔서(이하 &quot;회사&quot;라 합니다)가 제공하는 에브리엔서 서비스 및 캠퍼스픽 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.</p>
  ...
  <ol>
    ...
    <ol>
      ...
      <li>&quot;이용 기록&quot;이란, 이용자가 서비스를 이용하면서 직접 생성한 전공 질문, 전공 답변, 기타 정보 등을 말합니다.</li>
  ...
  <ol>
    ...
    <ol>
      <li>전공 질문을 나눌 수 있는 커뮤니티 서비스</li>
      <li>기타 회사가 정하는 서비스</li>
    </ol>
    <li>에브리엔서는 학생증, 학교 웹메일, 증명서 등을 통해 해당 대학교의 학부 재학생 및 졸업생 또는 해당연도 입학생으로 인증받은 이용자에게 인증을 해주는 인증형 서비스입니다. 에브리엔서의 학교 인증을 받지 않은 이용자 및 불특정 다수의 일반 이용자는 커뮤니티를 포함한 대부분의 기능에 접근할 수 없습니다.</li>
  ...
  <h3>제9조(저작권의 귀속)</h3>
  <ol>
    <li>회사는 유용하고 편리한 서비스를 제공하기 위해, 2023년부터 서비스 및 서비스 내부의 기능(전공 질문 게시판 등)의 체계와 다양한 기능을 직접 설계 및 운영하고 있는 데이터베이스 제작자에 해당합니다. 회사는 저작권법에 따라 데이터베이스 제작자는 복제권 및 전송권을 포함한 데이터베이스 전부에 대한 권리를 가지고 있으며, 이는 법률에 따라 보호를 받는 대상입니다. 그러므로 이용자는 데이터베이스 제작자인 회사의 승인 없이 데이터베이스의 전부 또는 일부를 복제·배포·방송 또는 전송할 수 없습니다.</li>
  ...
  <h3>제15조(기타)</h3>
  <ol>
    <li>이 약관은 2023년 1월 26일에 처음 작성되었습니다.</li>
...
const policy = <>
  <h3>1. 개인정보 처리방침</h3>
  <p>개인정보 처리방침은 에브리엔서(이하 &quot;회사&quot;라 합니다)가 특정한 가입절차를 거친 인증형 서비스를 제공함에 있어, 개인정보를 어떻게 수집·이용·보관·파기하는지에 대한 정보를 담은 방침을 의미합니다. 개인정보 처리방침은 개인정보보호법 등 국내 개인정보 보호 법령을 모두 준수하고 있습니다. 본 개인정보 처리방침에서 정하지 않은 용어의 정의는 서비스 이용약관을 따릅니다.</p>

  <h3>2. 수집하는 개인정보의 항목</h3>
  <p>회사는 서비스 제공을 위해 다음 항목 중 최소한의 개인정보를 수집합니다.</p>

  <h4>1) 회원가입 시 수집되는 개인정보</h4>
  <p>학교, 아이디, 이메일, 이름, 휴대전화 번호, 통신사 정보, 생년월일, 성별, 입학연도, 닉네임, 연계정보(CI, DI)</p>

  <h4>2) 별도로 수집되는 개인정보</h4>
  <ol>
    <li>학교 인증을 할 경우</li>
    <ol>
      <li>학과, 학교 이메일, 학번, 수험번호, 마스킹 된 증빙 자료 사본(학생증, 학교 포털 스크린샷, 학교 증명서)</li>
    </ol>
  ...
  <p> ※ 위 항에도 불구하고 법령에 의해 개인정보를 보존해야 하는 경우, 해당 개인정보는 물리적·논리적으로 분리하여 해당 법령에서 정한 기간에 따라 저장합니다.<br/> ※ 회원 탈퇴, 보관 기한 만료 등
    ...
    소각하여 파기합니다.<br/> ※ 회원이 1년 이상 로그인 및 접속을 하지 않을 경우, 해당 계정은 휴면 계정으로 전환됩니다. 개인정보의 안전한 처리를 위해 휴면 계정의 학교, 아이디, 이메일, 이름,
      닉네임, 입학연도, 연계정보는 분리 보관되며, 이외의 개인정보 및 이용기록은 모두 파기될 수 있습니다. 휴면 계정이 로그인에 성공할 경우, 휴면 상태가 즉시 해제되어 모든 서비스를 이용할 수 있습니다. 휴면
      계정 전환 이후에도 3년 동안 로그인을 하지 않을 경우, 해당 계정은 영구 삭제됩니다.<br/> ※ 학교 인증 시, 위조·도용 피해를 방지하기 위해 학교, 학번, 학교 이메일을 비식별화하여 1년 동안
        보관합니다.<br/> ※ 부정행위 시, 제재 및 제재 내역 확인을 위해 IP, 게시물, 회원번호, 비식별화한 정보(학교, 학번, 학교 이메일, 연계정보)를 이용제한 종료일로부터 1년 동안 보관합니다.<br/>
          ※ 강의평가 포인트 내역은 비식별화된 연계정보에 저장되며, 포인트 보호를 위해 파기되지 않습니다.<br/> ※ 비식별화란? 일방향 암호화 처리를 통해 개인정보를 익명 처리하는 과정을 말합니다. 비식별화된
          정보는 복호화가 불가능하며, 회사를 포함하여 누구라도 이 정보로 개인을 식별하거나 유추할 수 없습니다.</p>

  <h3>7. 정보주체의 권리, 의무 및 행사</h3>
  <p>회원은 언제든지 서비스 내부 [내 정보] 또는 에브리엔서 문의하기를 통해 자신의 개인정보를 조회하거나 수정, 삭제, 탈퇴를 할 수 있습니다.</p>
  ...
  <ol>
    <li>개인정보보호 담당 부서 : 에브리엔서 정보보호팀</li>
    <li>에브리엔서 정보보호팀 이메일 : official.everyanswer@gmail.com</li>
  </ol>
  ...
  <h3>10. 기타</h3>
  <p>이 개인정보 처리방침은 2023년 1월 26일 처음 작성되었습니다.</p>
</>